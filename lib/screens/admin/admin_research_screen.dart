...
Widget build(BuildContext context) {
  return LayoutBuilder(
    builder: (context, constraints) {
      ...
      final containerWidth = width > 1400 ? 1300.0 : double.infinity;
              ...
              child: isWide
                  ? Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          flex: 6,
                          child: _buildResearchWorksSection(),
                        ),
                      ],
                    )
                  : Column(
    ...
    return isCompact
        ? Column(
            ...
            children: [
              CircleAvatar(
                ...
                backgroundImage:
                    widget.faculty.userModel.profilePictureURL != null
        ...
        : Row(
            children: [
              ...
              Expanded(child: _buildFacultyInfo()),
            ],
          );
  },
),
  ...
  Widget _buildFacultyInfo() {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(widget.faculty.personalInfo.name,
